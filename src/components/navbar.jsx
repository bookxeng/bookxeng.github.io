...
const Navbar = () =>{
    return(
        <div className="fixed w-full h-[80px] flex justify-between items-center px-4 text-gray-300 z-20">
            <div>
            ...
            <div className="hidden lg:flex fixed flex-col right-0 top-[35%]">
                <ul>
                    <li className="font-bold flex w-[160px] h-[60px] items-center mr-[-100px] hover:mr-[10px] duration-500">
                        <FaGithub size={35}/>&emsp; Github
                    </li>
                    <li className="font-bold flex w-[160px] h-[60px] items-center mr-[-100px] hover:mr-[10px] duration-500">
                        <MdEmail size={35}/>&emsp; E-mail
                    </li>
                </ul>
            </div>
        </div>
